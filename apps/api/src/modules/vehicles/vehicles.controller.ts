...
export class VehiclesController {
  ...
  @ApiOperation({
    summary: 'Get vehicle details, timelines, and computed financials',
  })
  ...
  @Roles(UserRole.Admin, UserRole.FleetManager)
  @ApiOperation({
    summary: 'Update vehicle status (triggers history tracking)',
  })
  async updateStatus(
    @Param('id') id: string,
  ...
  @Roles(UserRole.Admin, UserRole.FleetManager)
  @ApiOperation({
    summary: 'Soft-delete a vehicle (prevents active trip deletion)',
  })
